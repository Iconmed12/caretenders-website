      ...
      try {
        ...
        if (RESEND_KEY && email) {
          const welcomeHtml = '<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">' +
            ...
            '</div>' +
            '<p style="padding:4px 0;"><a href="https://getcana.co.uk/register.html?email=' + encodeURIComponent(email) + '" style="display:inline-block;background:#00C9E0;color:#0B1929;font-weight:700;padding:11px 24px;border-radius:8px;text-decoration:none;font-size:14px;margin-right:8px;">Create your account &rarr;</a> <a href="https://getcana.co.uk" style="display:inline-block;background:#fff;border:1.5px solid #0B1929;color:#0B1929;font-weight:700;padding:10px 22px;border-radius:8px;text-decoration:none;font-size:14px;">Browse tenders</a></p>' +
