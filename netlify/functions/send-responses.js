...
exports.handler = async (event) => {
  ...
  try {
    ...
    const ICONGRP_EMAIL = 'hello@getcana.co.uk';
    ...
    htmlBody += '<hr style="margin-top:32px;"><p style="color:#9ca3af;font-size:11px;text-align:center;">Generated by Cana | ICONGRP Consulting | hello@getcana.co.uk</p>' +
      '</div></div>';
