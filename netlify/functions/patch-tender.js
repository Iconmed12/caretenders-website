...
exports.handler = async (event) => {
  ...
  await logAudit(event, 'patch-tender', (function(){ try { var b = JSON.parse(event.body); return { tenderId: b.tenderId, fields: b.fields && Object.keys(b.fields) }; } catch(e){ return null; } })());
