...
function addCanaQuestion(q, wordLimit, scoring) {
  ...
  d.style.cssText = 'background:#fff;border-radius:12px;padding:1rem 1.1rem;margin-bottom:10px;box-shadow:var(--card-shadow);';
  ...
  ta.value = q;
  ta.style.cssText = 'width:100%;min-height:80px;padding:11px 14px;border:1px solid var(--field-border);background:var(--field-bg);border-radius:10px;font-size:0.85rem;font-family:DM Sans,sans-serif;resize:vertical;line-height:1.6;outline:none;';
  ...
  wlInp.style.cssText = 'padding:10px 12px;border:1px solid var(--field-border);background:var(--field-bg);border-radius:10px;font-size:0.8rem;font-family:DM Sans,sans-serif;outline:none;';
  var scInp = document.createElement('input');
  scInp.type = 'text';
  scInp.placeholder = 'Scoring (optional) e.g. 22%';
  scInp.value = scoring;
  scInp.style.cssText = 'padding:10px 12px;border:1px solid var(--field-border);background:var(--field-bg);border-radius:10px;font-size:0.8rem;font-family:DM Sans,sans-serif;outline:none;';
...
async function setTenderStatus(id, newStatus) {
  try {
    var res = await adminPatchTender(id, { status: newStatus });
