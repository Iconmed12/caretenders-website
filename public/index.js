  ...
  function openModal(t) {
    ...
    // Source link removed from the customer view: customers should not be sent
    // to the original government notice (they could bypass Cana). The admin has
    // its own source links for the team.
